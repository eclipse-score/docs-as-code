...
from sphinx_autobuild.__main__ import main as sphinx_autobuild_main  # type: ignore[reportUnknownVariableType] # sphinx_autobuild doesn't provide complete type annotations
