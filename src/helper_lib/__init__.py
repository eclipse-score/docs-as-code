...
from src.extensions.score_source_code_linker.testlink import DataOfTestCase, TestLink
...
def get_github_link(link: NeedLink | TestLink | DataOfTestCase | None = None) -> str:
    if link is None:
