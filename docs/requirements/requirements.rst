...
.. needtable:: SUCCESSFUL TEST
   ...
   :tags: TEST
   :columns: id as "source_link";name as "testcase";result;fully_verifies;partially_verifies;test_type;derivation_technique


.. needtable:: FAILED TEST
   :filter: result == "failed"
   :tags: TEST
   :columns: id;result;result_text;fully_verifies;partially_verifies;test_type;derivation_technique
